...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 pt-16 pb-8">
                  ...
                  <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div className="px-4 py-3 border-b border-base-300 bg-base-100">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-sm sm:text-base">John Doe</h3>
                          <p className="text-xs sm:text-sm text-base-content/70">Online</p>
                        </div>
                      </div>
                    </div>

                    {/* Messages */}
                    <div className="p-4 space-y-3 min-h-[150px] max-h-[250px] overflow-y-auto bg-base-100">
                      {PREVIEW_MESSAGES.map((message) => (
                        ...
                        >
                          <div
                            className={`max-w-[75%] sm:max-w-[80%] rounded-xl p-2 sm:p-3 shadow-sm
                    ...
                    <div className="p-4 border-t border-base-300 bg-base-100">
                      <div className="flex gap-2">
                        <input
                          type="text"
                          className="input input-bordered flex-1 text-sm sm:text-base h-10"
